...
const Account = ({ error, invalid, subbmitting, handleSubmit, updatePassword, providerId }) => {
  return (
    <Segment>
      ...
      {providerId && providerId === "password" &&
        <div>
          ...
          <Form onSubmit={handleSubmit(updatePassword)}>
            ...
            <Divider />
            <Button disabled={invalid || subbmitting} size="large" positive content="Update Password" />
          </Form>
        </div>
      }
